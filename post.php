<html>
    ...
    <div id="main">
        <main>
            ...
            </div><!--close for briefdescription-->
            <div id="author">
                <p><a href="https://www.allrecipes.com/recipe/6865/to-die-for-blueberry-muffins/">allrecipes</a></p>
            </div><!--close for author-->
            <img src="images/blueberrymuffin.jpg" alt="Blueberry Muffins on Cooling Tray" title="Blueberry Muffins">
            <div id="ingredients">
                <h3>Ingredients</h3>
                <ul>
                ...
                <br>
                <h3>Crumble Topping Ingredients</h3>
                <ul>
            ...
            <div id="nutrion">
                ...
                <p>383 calories</p>
                <p>protein 4.3g</p>
                <p>carbohydrates 56.9g</p>
                <p>fat 16.1g</p>
                <p>cholesterol 39.3mg</p> 
                <p>sodium 321.8mg</p>
            </div><!--close for nutrition-->
        </main>
    </div><!--close for main-->
